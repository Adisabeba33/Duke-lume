...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    descriptionLong:
      "Agate Bloom is the collection's idea in miniature — the botanical and the mineral fused. Thick, buttery strokes build petals of peach and blue around a single striped stone.",
    status: "print_available",
    featured: false,
    galleryOrder: 13,
    displaySize: "tall",
